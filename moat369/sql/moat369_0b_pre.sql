...
SPO &&step_pre_file_driver.
PRO SET TERM ON
PRO ACCEPT license_pack_param char format a1 default 'N' PROMPT "Oracle Pack License? (Tuning, Diagnostics or None) [ T | D | N ] (required): "
PRO PRO
PRO @@&&fc_set_term_off.
SPO OFF
...
BEGIN
  IF '&&license_pack.' = 'N' AND '&moat369_conf_ask_license.' = 'Y' AND 1=2 THEN
