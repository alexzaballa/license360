...
HOS echo "DEF license360_grid_home = '"$(ps -ef | &&cmd_grep. ocssd.bin | &&cmd_grep. -v &&cmd_grep. | &&cmd_awk. -F'/[^/]*$' '{print $1}' | &&cmd_awk. -F'/[^/]*$' '{print $1}' | &&cmd_awk. -F'^[^/]*/' '{print "/"$2}')"'" > &&step_file.
@&&step_file.
HOS rm -f &&step_file.
UNDEF step_file
...
HOS $ORACLE_HOME/OPatch/opatch lspatches -oh &&license360_grid_home. > &&out_filename.

DEF one_spool_text_file = '&&out_filename.'
DEF one_spool_text_file_rename = 'Y'
DEF skip_html = '--';
DEF skip_text_file = ''
EXEC :sql_text := '$ opatch lspatches -oh &&license360_grid_home.';
@@&&9a_pre_one.
...
HOS $ORACLE_HOME/OPatch/opatch lsinv -details -oh &&license360_grid_home. > &&out_filename.

DEF one_spool_text_file = '&&out_filename.'
DEF one_spool_text_file_rename = 'Y'
DEF skip_html = '--';
DEF skip_text_file = ''
EXEC :sql_text := '$ opatch lsinv -details -oh &&license360_grid_home.';
@@&&9a_pre_one.
...
HOS $ORACLE_HOME/OPatch/opatch lsinv -all -oh &&license360_grid_home. > &&out_filename.

DEF one_spool_text_file = '&&out_filename.'
DEF one_spool_text_file_rename = 'Y'
DEF skip_html = '--';
DEF skip_text_file = ''
EXEC :sql_text := '$ opatch lsinv -all -oh &&license360_grid_home.';
@@&&9a_pre_one.

/*****************************************************************************************/

UNDEF license360_grid_home
UNDEF out_filename
